            ...
            <main className="flex-1 p-4 lg:p-6">
                <div className="mx-auto max-w-6xl grid gap-4">
                    <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-1">
                            <h1 className="font-semibold text-5xl text-purple-400">Agenda Creation</h1>
                ...
                >
                  ...
                  <line x1="3" x2="21" y1="10" y2="10"></line>
                                ...
                                <span className="font-bold text-5xl text-[#1a202c] mr-6">Today</span>
                                <span className="text-xl font-bold ml-auto w-full text-right text-[#1a202c]">12:00pm - 1:00pm</span>
                            </div>
                            <div className="grid gap-7">
                                <div className="grid gap-1">
                                    <h2 className="font-semibold text-xl text-[#1a202c]">Last Meet</h2>
                                    <p className="text-lg text-semibold">Gen AI</p>
                                </div>
                                <div className="grid gap-1">
                                    <h2 className="font-semibold text-xl  text-[#1a202c]">New Features</h2>
                    ...
                    <div className="grid gap-4">
                        <div className="grid gap-2">
                            <h2 className="font-bold text-3xl mt-6 text-purple-400">Suggested Agenda Items</h2>
                            <p className="text-lg mt-2">
                                Enter the details of your meeting and we'll suggest agenda items based on your input.
                            </p>
                        </div>
                        <div className="grid gap-4">
                            <div className="grid gap-2">
